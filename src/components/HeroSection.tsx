    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center text-center max-w-4xl w-full">
          ...
          {/* Top badge */}
          <div
            className="badge-animated mb-6 inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-sm font-semibold"
            style={{ background:"rgba(22,163,74,0.1)", border:"1.5px solid rgba(22,163,74,0.25)", color:"#15803d", backdropFilter:"blur(8px)", fontFamily:"'DM Sans', sans-serif", letterSpacing:"0.03em" }}
          >
            <span style={{ fontSize:"16px" }}>🍲</span> Vidyanagar's Mess Finder
          </div>
